...
String selectedAnswer="";
    ...
    final long QUESTION_TIME_LIMIT = 16000;
...
void highlightSelectedOption(Button selectedButton)
{
    selectedButton.setBackgroundColor(
            selectedAnswer.equals(QuestionAnswer.correctAnswers[currentQuestionIndex]) ? Color.GREEN : Color.RED
    );
}
    void disableOptions()
    {
    ...
    void displayCorrectAnswer()
    {
        ...
        for (int i = 0; i < QuestionAnswer.choices[currentQuestionIndex].length; i++) {
            if (QuestionAnswer.choices[currentQuestionIndex][i].equals(QuestionAnswer.correctAnswers[currentQuestionIndex])) {
